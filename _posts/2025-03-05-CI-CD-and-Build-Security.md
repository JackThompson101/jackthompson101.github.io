...
![[/assets/images/CICDImgs/Pasted image 20250228013316.png]]

Later on when creating reverse shells make sure to use the CCID IP and not your machine IP.
![[/assets/images/CICDImgs/Pasted image 20250228013453.png]]
...
![[/assets/images/CICDImgs/Pasted image 20250304212406.png]]
...
![[/assets/images/CICDImgs/Pasted image 20250227234122.png]]

Ensure you can log in and we are ready to go
![[/assets/images/CICDImgs/Pasted image 20250228013644.png]]
![[/assets/images/CICDImgs/Pasted image 20250304212423.png]]
## Task 3: What is CI/CD and Build Security?
All these questions can be found in the reading
![[/assets/images/CICDImgs/Pasted image 20250228013135.png]]
```
build orchestrator
build agents
maximum visibility
...
![[/assets/images/CICDImgs/Pasted image 20250228015718.png]]
Then go to gitlab and fork the basic build project. 
![[/assets/images/CICDImgs/Pasted image 20250228015852.png]]
...
![[/assets/images/CICDImgs/Pasted image 20250228020034.png]]
...
```
![[/assets/images/CICDImgs/Pasted image 20250228020240.png]]
![[/assets/images/CICDImgs/Pasted image 20250228020447.png]]
Now let's head back to gitlab and we will see that our project runner has been created
![[/assets/images/CICDImgs/Pasted image 20250228020512.png]]
Edit the setting of the runner and select the "Run untagged jobs" button
![[/assets/images/CICDImgs/Pasted image 20250228020541.png]]
If your build fails like so:
![[/assets/images/CICDImgs/Pasted image 20250228021932.png]]
![[/assets/images/CICDImgs/Pasted image 20250228022002.png]]
...
![[/assets/images/CICDImgs/Pasted image 20250228022046.png]]
Now we can navigate to `http://127.0.0.1:8081`
![[/assets/images/CICDImgs/Pasted image 20250228022306.png]]
Finally let's complete this task by logging in with the credentials `admin:admin`
![[/assets/images/CICDImgs/Pasted image 20250228022353.png]]
![[/assets/images/CICDImgs/Pasted image 20250228022424.png]]
```
Gitlab Runner
...
![[/assets/images/CICDImgs/Pasted image 20250228014330.png]]
Create a new Personal Access token 
![[/assets/images/CICDImgs/Pasted image 20250228014317.png]]
![[/assets/images/CICDImgs/Pasted image 20250228014358.png]]
...
for project in projects:
    ...
    try:
        ...
        pass
```
![[/assets/images/CICDImgs/Pasted image 20250228014439.png]]
...
![[/assets/images/CICDImgs/Pasted image 20250228014624.png]]
Now we can run the enumerator and it will download a bunch of files
![[/assets/images/CICDImgs/Pasted image 20250228014649.png]]
We will be focusing on the mobile app file, let's unzip it.
![[/assets/images/CICDImgs/Pasted image 20250228014737.png]]
Then we can cd in and use `grep -iR key *` to find any references to key in the directory.
![[/assets/images/CICDImgs/Pasted image 20250228014812.png]]
This worked and we can now finished with this task.
![[/assets/images/CICDImgs/Pasted image 20250228014057.png]]
```
.gitignore
branches
...
![[/assets/images/CICDImgs/Pasted image 20250227235000.png]]
![[/assets/images/CICDImgs/Pasted image 20250227235019.png]]
We have the flag and have completed the task.
![[/assets/images/CICDImgs/Pasted image 20250304210111.png]]
```
secure registry
secret management
...
![[/assets/images/CICDImgs/Pasted image 20250227235326.png]]
![[/assets/images/CICDImgs/Pasted image 20250227235403.png]]
...
![[/assets/images/CICDImgs/Pasted image 20250227234214.png]]
Now let's configure it to work for the `jenkins` machine
![[/assets/images/CICDImgs/Pasted image 20250227234415.png]]
Now that we have a shell let's go back to mother and see what we need to do to get the flag
![[/assets/images/CICDImgs/Pasted image 20250227234813.png]]
Simply follow the steps that mother has for us...
![[/assets/images/CICDImgs/Pasted image 20250227234719.png]]
![[/assets/images/CICDImgs/Pasted image 20250227234648.png]]
...
![[/assets/images/CICDImgs/Pasted image 20250227234845.png]]
We have the flag let's move on.
![[/assets/images/CICDImgs/Pasted image 20250304210446.png]]
```
VPN
...
![[/assets/images/CICDImgs/Pasted image 20250227235812.png]]
...
```
![[/assets/images/CICDImgs/Pasted image 20250228000942.png]]
Open a new `nc` listener.
![[/assets/images/CICDImgs/Pasted image 20250228001046.png]]
...
![[/assets/images/CICDImgs/Pasted image 20250228000152.png]]
![[/assets/images/CICDImgs/Pasted image 20250228001128.png]]
If we head back to our listener we should see that we have a shell
![[/assets/images/CICDImgs/Pasted image 20250228001138.png]]
Let's find what machine we are on so we can give the hostname to the mother:
![[/assets/images/CICDImgs/Pasted image 20250228001218.png]]
![[/assets/images/CICDImgs/Pasted image 20250228001228.png]]
Now let's give the hostname `GRunner01` to the mother
![[/assets/images/CICDImgs/Pasted image 20250228001300.png]]
Now let's do what the mother says by adding the flag
![[/assets/images/CICDImgs/Pasted image 20250228001415.png]]
Finally let's verify with the mother to complete the room.
![[/assets/images/CICDImgs/Pasted image 20250228001456.png]]
![[/assets/images/CICDImgs/Pasted image 20250304210545.png]]
```
merge requests
limit runner access
...
![[/assets/images/CICDImgs/Pasted image 20250228002818.png]]

On the dev branch let's add our trusty reverse shell script. To the `.gitlab-ci.yml` file, and merge it in.![[/assets/images/CICDImgs/Pasted image 20250228003905.png]]
```
stages:
  - deploy
...
production:
  ...
  environment:
    name: ${CI_JOB_NAME}
```
![[/assets/images/CICDImgs/Pasted image 20250228003955.png]]
...
![[/assets/images/CICDImgs/Pasted image 20250228010227.png]]
![[/assets/images/CICDImgs/Pasted image 20250228010310.png]]
 
![[/assets/images/CICDImgs/Pasted image 20250228004557.png]]
...
![[/assets/images/CICDImgs/Pasted image 20250228005728.png]]

Now let's get a proper shell and try again
````bash
python3 -c 'import pty; pty.spawn("/bin/bash")'
````
![[/assets/images/CICDImgs/Pasted image 20250228010439.png]]
Now let's try to ssh again
![[/assets/images/CICDImgs/Pasted image 20250228010602.png]]
Now we are in, let's complete the steps from the mother
![[/assets/images/CICDImgs/Pasted image 20250228011124.png]]
![[/assets/images/CICDImgs/Pasted image 20250228010938.png]]
Now let's verify with the mother 
![[/assets/images/CICDImgs/Pasted image 20250228010957.png]]
...
![[/assets/images/CICDImgs/Pasted image 20250228011049.png]]
![[/assets/images/CICDImgs/Pasted image 20250228011203.png]]
![[/assets/images/CICDImgs/Pasted image 20250304211018.png]]
```
...
![[/assets/images/CICDImgs/Pasted image 20250228011453.png]]
...
![[/assets/images/CICDImgs/Pasted image 20250228012758.png]]

Now lets go back to our reverse shell from Task 9 and we can get the flag
![[/assets/images/CICDImgs/Pasted image 20250228012640.png]]
...
![[/assets/images/CICDImgs/Pasted image 20250304210944.png]]
```
nay
